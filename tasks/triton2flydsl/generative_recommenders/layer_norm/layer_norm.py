...
`switch_to_contiguous_if_needed`, `is_sm100_plus`, `is_sm90`) are inlined; the SM
checks return False so the CDNA-appropriate autotune configs are selected.
"""
...
# On AMD/CDNA these are False; they only steer autotune config breadth.
def is_sm90() -> bool:
    return False
